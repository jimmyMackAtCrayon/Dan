...
-- Populate Location
INSERT INTO Location VALUES(1, 'Maine', 'ME', 9)
INSERT INTO Location VALUES(2, 'New Jersey', 'NJ', 19)
INSERT INTO Location VALUES(3, 'New York', 'NY', 29)

-- Populate Owner
INSERT INTO Owner VALUES(1, 'Dan', 'Mom')
INSERT INTO Owner VALUES(2, 'Jeff', 'Dad')
INSERT INTO Owner VALUES(3, 'Other', 'Vic')
...
-- Populate Warehouse
INSERT INTO Warehouse VALUES(1, 'Docks', 1)
INSERT INTO Warehouse VALUES(2, 'Downtown',  2)
INSERT INTO Warehouse VALUES(3, 'Uptown', 3)


-- Populate Barrel
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  1,		1,      1,      1,           1,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  2,		2,      1,      1,           1,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  3,		2,      1,      1,           1,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  4,		1,      1,      1,           1,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  5,		3,      1,      1,           2,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  6,		1,      1,      1,           3,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  7,		2,      1,      1,           2,            1,	   '#101',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  8,		3,      1,      1,           1,            1,	   '#101',	  '1/1/2022',			0,			null,				0)

INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  9,		1,      1,      2,           2,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  10,		2,      1,      2,           3,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  11,		3,      1,      2,           1,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  12,		1,      1,      2,           2,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  13,		2,      1,      2,           3,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  14,		3,      1,      2,           1,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  15,		2,      1,      2,           2,            2,	   '#102',	  '1/1/2022',			0,			null,				0)
INSERT INTO Barrel
		([BarrelId],[OwnerId],[LotId],[DSP_Id],[LocationId],[WarehouseId],[InvoiceNo],[PurchaseDate],[ArchiveFlag],[ArchiveDate],[PendingSaleFlag])
  values(		  16,		2,      1,      2,           3,            2,	   '#102',	  '1/1/2022',			0,			null,				0)

-- Populate Internal Spirit
INSERT INTO InternalSpiritType values(1, 'Whiskey')
INSERT INTO InternalSpiritType values(2, 'Rye')
INSERT INTO InternalSpiritType values(3, 'Scotch')
INSERT INTO InternalSpiritType values(4, 'Bourbon')
go



select l.LotId,l.DSP_Id, SpiritName, InvoiceNo, lc.LocationName, w.WarehouseName, o.OwnerName, d.DSP_Name from lot l 
